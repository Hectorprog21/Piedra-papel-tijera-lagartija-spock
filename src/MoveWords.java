...
public class MoveWords{
    ...
    public static final String[] validMoves = {"TIJERAS","PAPEL","LAGARTIJA","SPOCK","PIEDRA"};
    ...
    public static int checkWinner(String first, String second){
        ...
        else if ((first_i == 0) && (second_i == 1 || second_i == 2)){
         return GANA;
        }
        else if ((first_i == 1) && (second_i == 3 || second_i == 4)){
            return GANA;
        }
        else if ((first_i == 2) && (second_i == 1 || second_i == 3)){
            return GANA;
        }
        else if ((first_i == 3)&& (second_i == 0 || second_i == 4)){
            return GANA;
        }
